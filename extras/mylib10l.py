...
class brain(nn.Module):
    ...
    def __init__(self, input_size, output_size):
        ...
        self.fc4 = nn.Linear(self.input_size, round(self.input_size*.5))
        self.fc5 = nn.Linear(round(self.input_size*.5), round(self.output_size*.5))
        self.fc6 = nn.Linear(round(self.output_size*.5), round(self.output_size*.75))
        self.fc7 = nn.Linear(round(self.output_size*.75), round(self.output_size*1.25))
        self.fc8 = nn.Linear(round(self.output_size*1.25), round(self.output_size*1.75))
        self.fc9 = nn.Linear(round(self.output_size*1.75), round(self.output_size*1.5))
        self.fc10 = nn.Linear(round(self.output_size*1.5), self.output_size)
